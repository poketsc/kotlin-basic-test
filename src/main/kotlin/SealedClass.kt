...
data class NewBackendDeveloper(override val name: String) : NewDeveloper() {
...
data class FrontendDeveloper(override val name: String) : NewDeveloper() {
...
object OtherDeveloper : NewDeveloper() {
...
data class AndroidDeveloper(override val name: String) : NewDeveloper() {
...
data class IosDeveloper(override val name: String) : NewDeveloper() {
...
object DeveloperPool {
    val pool = mutableMapOf<String, NewDeveloper>()

    fun add(developer: NewDeveloper) = when(developer) {
        is NewBackendDeveloper -> pool[developer.name] = developer
...
fun main() {
    val backendDeveloper = NewBackendDeveloper(name="토니")
